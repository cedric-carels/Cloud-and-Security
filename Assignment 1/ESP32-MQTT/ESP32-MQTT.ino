...
const char* mqtt_server  = "54.75.32.245";
const int mqtt_port  = 1883;
#define MQTT_SERIAL_PUBLISH_CH "r0804148/measurement"
#define MQTT_SERIAL_RECEIVER_CH "r0804148/led"
const String DEVICE_ID = "r0804148";
