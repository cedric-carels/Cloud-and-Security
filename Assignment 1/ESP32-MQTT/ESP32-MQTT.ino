...
const char* mqtt_server  = "xxx.x.x.x";                   // IP adres van de mqtt dat je uit nodejs comand uithaald
const int mqtt_port  = xxxx;                              // poort van de mqtt dat je uit nodejs comand uithaald
#define MQTT_SERIAL_PUBLISH_CH "r0804148/measurement"     // publish voor NODE-RED connectie, je kan dat naam kiezen
#define MQTT_SERIAL_RECEIVER_CH "r0804148/led"            // receiver voor NODE-RED connectie, je kan dat naam kiezen
const String DEVICE_ID = "r0804148";                      // naam van jouw device ID

#define LED_PIN 13      // led is verbonden met D13 op esp
#define DHTPIN 2       // DHT11 is verbonden met D2 op esp
#define DHTTYPE DHT11   // welke type DHT gebruik je
